...
STATUS_LOG="logs/manual_task_status_${RUN_TAG}.jsonl"
PROGRESS_CSV="output/manual_task_progress_${RUN_TAG}.csv"
MAPPING_CSV="output/task_file_mapping_${RUN_TAG}.csv"
RUN_LOG="logs/run_log_${RUN_TAG}.jsonl"
RUN_INFO="logs/manual_loop_run_${RUN_TAG}.txt"
...
"$PYTHON_EXE" "scripts/manual_loop_driver.py" \
  --config "$CONFIG_PATH" \
